...
import net.docv.shizen.item.fruits.Apricot;
import net.docv.shizen.item.fruits.Banana;
import net.docv.shizen.item.fruits.Grape;
import net.docv.shizen.item.fruits.Lemon;
import net.docv.shizen.item.fruits.Orange;
import net.docv.shizen.item.fruits.Peach;
import net.docv.shizen.item.fruits.Pear;
import net.docv.shizen.item.fruits.Plum;
...
public class Items {
	...
	public static final Item APRICOT_SAPLING = register("apricot_sapling", Blocks.APRICOT_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item BANANA_SAPLING = register("banana_sapling", Blocks.BANANA_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item GRAPE_SAPLING = register("grape_sapling", Blocks.GRAPE_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item LEMON_SAPLING = register("lemon_sapling", Blocks.LEMON_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item PEACH_SAPLING = register("peach_sapling", Blocks.PEACH_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item ORANGE_SAPLING = register("orange_sapling", Blocks.ORANGE_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item PEAR_SAPLING = register("pear_sapling", Blocks.PEAR_SAPLING, ItemGroup.DECORATIONS);
	...
	public static final Item PLUM_SAPLING = register("plum_sapling", Blocks.PLUM_SAPLING, ItemGroup.DECORATIONS);
