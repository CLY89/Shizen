...
public class PeachTreeFeature extends TreeFeature {
	public PeachTreeFeature(Codec<BaseTreeFeatureConfig> codec) {
		super(codec);
	}
	...
	public ConfiguredFeature<BaseTreeFeatureConfig, ?> setConfiguration() {
		return this.withConfiguration(
				new BaseTreeFeatureConfig.Builder(
						new SimpleBlockStateProvider(Blocks.PEACH_LOG.getDefaultState()),
						new SimpleBlockStateProvider(Blocks.PEACH_LEAVES.getDefaultState()),
