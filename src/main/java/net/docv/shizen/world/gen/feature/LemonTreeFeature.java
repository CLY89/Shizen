...
public class LemonTreeFeature extends TreeFeature {
	public LemonTreeFeature(Codec<BaseTreeFeatureConfig> codec) {
		super(codec);
	}
	...
	public ConfiguredFeature<BaseTreeFeatureConfig, ?> setConfiguration() {
		return this.withConfiguration(
				new BaseTreeFeatureConfig.Builder(
						new SimpleBlockStateProvider(Blocks.LEMON_LOG.getDefaultState()),
