...
public class ApricotTreeFeature extends TreeFeature {
	public ApricotTreeFeature(Codec<BaseTreeFeatureConfig> codec) {
		super(codec);
	}
	...
	public ConfiguredFeature<BaseTreeFeatureConfig, ?> setConfiguration() {
		return this.withConfiguration(
				new BaseTreeFeatureConfig.Builder(
						new SimpleBlockStateProvider(Blocks.APRICOT_LOG.getDefaultState()),
						new SimpleBlockStateProvider(Blocks.APRICOT_LEAVES.getDefaultState()),
